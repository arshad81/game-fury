  ...
  return (
    <header>
      <div className="bg-montego-bay z-10 max-w-7xl mx-auto lg:bg-transparent lg:flex lg:justify-between lg:items-stretch lg:absolute lg:w-full lg:start-1/2 lg:-translate-x-1/2">
        <div
          className={`absolute transition-all duration-200 h-full w-full bg-white lg:hidden ${
            menuActive ? "" : "-translate-y-full"
          }  z-10 `}
        >
            <ul className={` delay-150 duration-200 transition-all ps-8 ${menuActive ? 'translate-y-28':'-translate-y-full'}`}>
        ...
        <div
          className={`absolute right-6 top-8 transition-all duration-300 z-20 ${
            menuActive ? "bg-poinciana fill-white" : "bg-white"
